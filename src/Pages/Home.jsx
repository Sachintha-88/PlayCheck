   ...
   return (
    <div className="App">
      ...
      <div className="flex flex-wrap mt-8"> 
        ...
        <GameCard src={acVlhlla} name="Assasin's Creed Valhalla" genres="Race, Open world, Drive, Multiplayer" version="v12.0.2" language="Rus/Eng/Multi" size={95}/>
        ...
        <GameCard src={acSyndicate} name="Assasin's Creed Syndicate" genres="Race, Open world, Drive, Multiplayer" version="v12.0.2" language="Rus/Eng/Multi" size={95}/>
