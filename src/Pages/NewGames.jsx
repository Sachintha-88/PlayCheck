...
function NewGames() {
  ...
  return (
    ...
    >
      ...
      {/* Page banner — same max-width + padding as Games grid */}
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 pt-6 sm:pt-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-slate-600 text-xs sm:text-sm mt-0.5 m-0">
              Fresh titles from {currentYear - 1}–{currentYear}
            </p>
          </div>
        </div>
        <div className="mt-2 h-[2px] rounded-full bg-gradient-to-r from-emerald-500 to-transparent" />
      </div>

      <main className="flex flex-1">
        <Games games={newGames} title="New Games" />
      </main>
